...
// The handle_drive_request callback function executes whenever a drive_bot
// service is requested.  This function will publish the requested linear x
// and angular velocities to the robot wheel joints.  After publishing the
// requested velocities, a message feedback is returned with the 
// requested wheel velocities.
bool handle_drive_request(ball_chaser::DriveToTarget::Request& req,
    ball_chaser::DriveToTarget::Response& res) {

    ROS_INFO("DriveToTarget req received: (linear_x:%1.2f, angular_z:%1.2f)", 
...
int main(int argc, char** argv)
{
    ...
    // geometry_msgs::Twist on the robot actuation topic with a 
